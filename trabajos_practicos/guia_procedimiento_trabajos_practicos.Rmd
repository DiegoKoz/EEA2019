...
![](imagenes/rpubs_paso_3.png){width=75%, height=75%}

5. Ingresar con su usuario y contraseña

![](imagenes/rpubs_paso_4.png){width=75%, height=75%}

6. Colocar el nombre del documento y si lo desean una pequeña descripción y la url 

![](imagenes/rpubs_paso_5.png){width=75%, height=75%}
