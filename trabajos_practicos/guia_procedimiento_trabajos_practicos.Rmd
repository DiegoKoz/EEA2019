...
![](rnotebook_paso_1.png){ width=75% }

2. Seleccionar **R Notebook**

![](rnotebook_paso_2.png){ width=75% }

3. Se les debe crear un nuevo notebook igual (o muy similar) a este

![](rnotebook_paso_3.png){ height=75%, width=75%}
...
![](rnotebook_paso_4.png){ height=75% }
...
![](rnotebook_paso_5.png){ height=75%, width=75%}
...
![](rnotebook_paso_6.png){ width=75%}

## 3. Usar RPubs

1. Ingresar en la pagina de [Rpubs](http://rpubs.com/) y registrarse si no tienen usuario. Recuerden la contraseña porque hay que enviar un mail para resetearla si se la olvidan.

2. Una vez que hayan realizado el R Notebook y hayan apretado el boton de **Preview**, deben apretar el boton de publish en la esquina superior derecha del notebook

![](rpubs_paso_1.png)

3. Seleccionar la opcion para publicarlo en Rpubs

![](rpubs_paso_2.png){width=75%}

4. Hacer click en **Publish**

![](rpubs_paso_3.png){width=75%, height=75%}

5. Ingresar con su usuario y contraseña

![](rpubs_paso_4.png){width=75%, height=75%}

6. Colocar el nombre del documento y si lo desean una pequeña descripción y la url 

![](rpubs_paso_5.png){width=75%, height=75%}

7. Deben llegar a un resultado similar a este con su R Notebook

![](rpubs_paso_6.png){width=50%, height=50%}
